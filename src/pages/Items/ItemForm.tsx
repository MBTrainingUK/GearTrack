  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-5 flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-ink">{isEdit ? 'Edit Item' : 'Add New Item'}</h1>
      </div>

      <form onSubmit={handleSubmit} className="rounded-xl border border-line bg-surface p-6 shadow-sm space-y-5">
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label className="mb-1 block text-sm font-medium text-ink-label">Name *</label>
            <input
              value={form.name}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Category *</label>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="shrink-0 rounded-lg border border-line px-3 py-2 text-sm text-ink-body hover:bg-surface-hover"
              >
                + Add
              </button>
            </div>
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Asset No.</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Serial No.</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Location</label>
            <input
              value={form.location}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Condition</label>
            <select
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Purchase Date</label>
            <input
              type="date"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Purchase Price (£)</label>
            <input
              type="number"
              min="0"
              step="0.01"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink-label">Inspection Interval (months)</label>
            <input
              type="number"
              min="1"
              step="1"
